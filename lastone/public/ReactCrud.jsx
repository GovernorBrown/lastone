    ...
    render: function () {
        return (
            <div className="container" style={{ marginTop: '50px' }}>
                <p className="text-center" style={{ fontSize: '25px' }}><b> Add Your Restaurant</b></p>
                <form>
                    <div className="col-sm-12 col-md-12" style={{ marginLeft: '430px'  }}>
                    ...
                    <div className="col-sm-12 col-md-12 " style={{ marginTop: '50px', marginLeft: '400px' }} >
...
ReactDOM.render(<StudentAll />, document.getElementById('root2'))